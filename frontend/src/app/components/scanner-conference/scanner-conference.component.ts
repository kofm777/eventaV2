// src/app/components/scanner-conference/scanner-conference.component.ts
...
@Component({
    selector: 'app-scanner-conference',
    standalone: true,
    imports: [CommonModule, FormsModule],
    templateUrl: './scanner-conference.component.html',
    styleUrls: ['./scanner-conference.component.css']
})
export class ScannerConferenceComponent implements OnInit, OnDestroy {
    ...
    private processTextScan(qrCode: string) {
        ...
        this.apiService.scanConference(scanData).subscribe({
